...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'scores_event', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='a', max_length=256),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.slug'
        db.delete_column(u'scores_event', 'slug')
    ...
    models = {
        ...
        u'scores.poll': {
            'Meta': {'ordering': "['ranking']", 'object_name': 'Poll'},
            'event': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['scores.Event']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
